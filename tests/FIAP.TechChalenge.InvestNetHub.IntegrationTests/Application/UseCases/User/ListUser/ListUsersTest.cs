...
using UseCase = FIAP.TechChalenge.InvestNetHub.Application.UseCases.User.ListUsers;
...
namespace FIAP.TechChalenge.InvestNetHub.IntegrationTests.Application.UseCases.User.ListUser;

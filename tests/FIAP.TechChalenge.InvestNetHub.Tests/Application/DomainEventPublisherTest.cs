...
namespace FIAP.TechChalenge.InvestNetHub.UnitTests.Application;
public class DomainEventPublisherTest
{
    ...
    public async Task PublishAsync()
    {
        ...
        eventHandlerMock1.Verify(x => x.HandleAsync(@event, It.IsAny<CancellationToken>()),
            Times.Once);
        eventHandlerMock2.Verify(x => x.HandleAsync(@event, It.IsAny<CancellationToken>()),
            Times.Once);

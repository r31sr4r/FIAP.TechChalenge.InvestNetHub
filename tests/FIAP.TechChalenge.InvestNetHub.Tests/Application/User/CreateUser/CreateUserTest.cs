using Moq;
using UseCases = FIAP.TechChalenge.InvestNetHub.Application.UseCases.User.CreateUser;
...
namespace FIAP.TechChalenge.InvestNetHub.UnitTests.Application.User.CreateUser;
